...
public class MessageAspect {
    ...
    @AfterReturning(value =
            "(execution(* com.otn.service.DiskService.saveDisk(..)) && args(versionId,netElementId,..)) ||" +
                    "(execution(* com.otn.service.DiskService.updateDisk(..)) && args(versionId,netElementId,..)) ||" +
                    "(execution(* com.otn.service.DiskService.listRemove(..)) && args(versionId,netElementId,..))",
    ...
    /*删除网元的时候要删除链路*/
    @AfterReturning(value = "execution(* com.otn.service.NetElementService.listRemoveNetElement(..)) && args(versionId,netElementIdList)",
    ...
    /*网元更新时更新链路*/
    @Around(value = "execution(* com.otn.service.NetElementService.updateNetElement(..)) && args(versionId," +
    ...
    @Around(value = "execution(* com.otn.service.LinkService.updateResLink(..)) && args(versionId," +
    ...
    /*删除链路时要重新计算相关的OSNR*/
    @Around(value = "execution(* com.otn.service.LinkService.listRemoveResLink(..)) && args(versionId," +
    ...
    /*添加链路时要重新计算相关的OSNR*/
    @AfterReturning(value = "execution(* com.otn.service.LinkService.saveResLink(..)) && args(versionId," +
    ...
    /*更新放大器的时候要更新机盘*/
    @Around(value = "execution(* com.otn.service.AmplifierService.updateAmplifiers(..)) && args(versionId," +
    ...
    /*更新链路类型的时候会更新链路*/
    @Around(value = "execution(* com.otn.service.LinkTypeService.updateByLinkTypeId(..)) && args(versionId," +
