...
public class LinkController {
    ...
    @ApiOperation(value = "查询某个版本下的某个环的链路信息")
    @RequestMapping(value = "/{versionId}/{circleId}", method = RequestMethod.GET)
    @ResponseStatus(HttpStatus.OK)
    @VersionCheckException(reason = "获取信息的时候不需要进行版本检查")
    public List<LinkDTO> listResLink(@PathVariable Long versionId, @PathVariable String circleId) {
        return linkService.listLinks(versionId, circleId);
    }
